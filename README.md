...
**Hello Rails React** is a random greeting project. I used React for frontend and Ruby on Rails for backend.
...
```sh
  cd <desired-folder>
  git clone https://github.com/Odongo006/Rails-React-App
```
...
- Twitter: [@GreatCoder](https://twitter.com/HenryOdongo007)
- LinkedIn: [Henry Omondi](https://www.linkedin.com/in/henry-odongo/)
